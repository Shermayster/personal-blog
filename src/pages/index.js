        ...
        {posts.map(({ node }) => {
          ...
          return (
            <Link
              ...
              hover:bg-gradient-to-r hover:from-indigo-500 hover:via-purple-500 hover:to-pink-500 hover:text-gray-50 transition duration-100 flex flex-col justify-center gap-1"
